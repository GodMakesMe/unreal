...
public class UranusIntroduction implements Screen {
    private Main Game;
    ...
    public UranusIntroduction(Main game) {
        this.Game = game;
    }
    ...
    public void show() {
        ...
        camera.update();
        sprite = new Sprite(new Texture("assets/UranusScreen.png"));
        ...
        Game.clickHandling(PlayButton, playButtonPixmap, new UranusLevel(Game));
    }
