...
public class NeptuneIntroduction implements Screen {
    private Main Game;
    ...
    private ImageButton Backbutton; private Pixmap backButtonPixmap;
    private ImageButton PlayButton; private Pixmap playButtonPixmap;

    public NeptuneIntroduction(Main game) {
        this.Game = game;
    }
    ...
    public void show() {
        ...
        camera.update();
        sprite = new Sprite(new Texture("assets/NeptuneScreen.png"));
        ...
        Game.clickHandling(PlayButton, playButtonPixmap, new NeptuneLevel(Game));
    }
