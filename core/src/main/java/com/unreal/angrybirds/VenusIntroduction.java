...
public class VenusIntroduction implements Screen {
    private Main Game;
    ...
    public VenusIntroduction(Main game) {
        this.Game = game;
    }
    ...
    public void show() {
        ...
        camera.update();
        sprite = new Sprite(new Texture("assets/VenusScreen.png"));
        ...
        Game.clickHandling(PlayButton, playButtonPixmap, new VenusLevel(Game));
    }
