...
public class MoonIntroduction implements Screen {
    private Main Game;
    ...
    public MoonIntroduction(Main game) {
        this.Game = game;
    }
    ...
    public void show() {
        ...
        camera.update();
        sprite = new Sprite(new Texture("assets/MoonScreen.png"));
        ...
        Game.clickHandling(PlayButton, playButtonPixmap, new MoonLevel(Game));
    }
