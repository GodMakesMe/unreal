...
// Pass the scaled deltaTime to the physics world
    ...
    public void show() {
        ...
        if (world == null) {
            world = new World(new Vector2(0, Game.spaceGravityByPlantName("Venus")), false);
            world.setGravity(new Vector2(0, Game.spaceGravityByPlantName("Venus")));
...
//                    world.destroyBody(SpaceBird.getBirdBody());
                    ...
                    if (birdsAvailable <= 0) {
                        ...
                        SpaceBird = new Bird("Red", 20, new WarCryAbility(), "assets/RedBirdMain.png",world,"Venus");
                        birdsAvailable--;
...
//                    world.destroyBody(SpaceBird.getBirdBody());
                    ...
                    if (birdsAvailable <= 0) {
                        ...
                        SpaceBird = new Bird("Chuck", 10, new SpeedAbility(), "assets/YellowBirdMain.png",world,"Venus");
                        birdsAvailable--;
                        BirdX  = SpaceBird.getX();
                        BirdY = SpaceBird.getY();
...
//                    world.destroyBody(SpaceBird.getBirdBody());
                    ...
                    if (birdsAvailable <= 0) {
                        ...
                        SpaceBird = new Bird("Blue", 8, new SplitAbility(), "assets/BlueBirdMain.png",world,"Venus");
                        birdsAvailable--;
                        BirdX  = SpaceBird.getX();
                        BirdY = SpaceBird.getY();
