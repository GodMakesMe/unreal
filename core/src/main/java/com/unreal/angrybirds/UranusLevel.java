...
//        Game.clickHandling(Nextbutton, nextButtonPixmap, new SpaceLevelEnd(Game));
        ...
        RedBirdButton.addListener(new InputListener() {
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (birdsAvailable > 1) SpaceBird = new Bird("Red", 20, null, "assets/RedBirdMain.png",world,"Uranus");
...
//                birdsAvailable--;
        ...
        YellowBirdButton.addListener(new InputListener() {
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (birdsAvailable > 1) SpaceBird = new Bird("Chuck", 10, null, "assets/YellowBirdMain.png",world,"Uranus");
                else {flag = false; return true;}
//                birdsAvailable--;
                flag = false;
                BirdX  = SpaceBird.getX();
        ...
        BlueBirdButton.addListener(new InputListener() {
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (birdsAvailable > 1) SpaceBird = new Bird("Blue", 8, null, "assets/BlueBirdMain.png",world,"Uranus");
                else{ flag = false; return true;}
//                birdsAvailable--;
                flag = false;
                BirdX  = SpaceBird.getX();
...
//
//                }
//                SpaceBird = new Bird("Bomb", 8, null, "assets/BombBirdMain.png",world,"Uranus");
//                birdsAvailable--;
//                BirdX  = SpaceBird.getX();
//                BirdY = SpaceBird.getY();
//                return true;
...
//                    world.destroyBody(SpaceBird.getBirdBody());
//                }
//                SpaceBird = new Bird("Matilda", 6, null, "assets/WhiteBirdMain.png",world,"Uranus");
//                birdsAvailable--;
//                BirdX  = SpaceBird.getX();
//                BirdY = SpaceBird.getY();
//                return true;
