...
public class NormalGuidePage implements Screen {
    private Main Game;
    ...
    public NormalGuidePage(Main Game) {
        this.Game = Game;
    }
    ...
    public void show() {
        ...
        camera.update();
        sprite = new Sprite(new Texture("assets/NormalGuidePage.png"));
        batch = new SpriteBatch();
        sprite.setPosition(0, 0);
        sprite.setSize(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
        ContinueButton = createButton("assets/NormalContinue.png","assets/NormalContinueHover.png",1064, 720 -634-50, 148, 50);
        ContinueButtonPixmap = new Pixmap(Gdx.files.internal("assets/NormalContinue.png"));
        Game.clickHandling(ContinueButton, ContinueButtonPixmap,new NormalLevel1(Game));
