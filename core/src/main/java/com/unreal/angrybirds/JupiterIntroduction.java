...
public class JupiterIntroduction implements Screen {
    private Main Game;
    ...
    public JupiterIntroduction(Main game) {
        this.Game = game;
    }
    ...
    public void show() {
        ...
        camera.update();
        sprite = new Sprite(new Texture("assets/JupiterScreen.png"));
        ...
        Game.clickHandling(PlayButton, playButtonPixmap, new JupiterLevel(Game));
    }
